...
class TranslationsPage extends LitElement {
  ...
  render() {
    return html`
      <h2>Translations</h2>
      <div class="description">Accessing scoped translation files to render a string in different languages. 
        By default the translation service will look for a /i18n/en.json at the root of your application.
        The TranslationController's loader can be overwritten to change this behavior.
      </div>
      <demo-section
